function CEdgeViewer (iX1,iY1,iX2,iY2,iLength,iHeight,oParentContainer){
    var _oRect;
    var _oParentContainer;
    
    this.init = function(iX1,iY1,iX2,iY2,iLength,iHeight,oParentContainer){
        ...
        _oParentContainer.addChild(_oRect);
    };
    ...
    this.unload = function(){
       _oParentContainer.removeChild(_oRect); 
    };
    
    this.init(iX1,iY1,iX2,iY2,iLength,iHeight,oParentContainer);
