function CEdge (iX1,iY1,iX2,iY2,iHeight,bVisible,oUserData,oParentContainer){
    var _oModel;
    var _oViewer;
    var _oPrevPoint;
    var _iCounterSize;
    ...
    this.init = function(iX1,iY1,iX2,iY2,iHeight,oUserData,oParentContainer){
        _oUserData = oUserData;
        _iCounterSize = 0;
        var oLength;
        _oModel = new CEdgeModel(iX1,iY1,iX2,iY2);
        oLength = _oModel.getLength();
        if (bVisible){
            _oViewer = new CEdgeViewer(iX1,iY1,iX2,iY2,oLength,iHeight,oParentContainer);
        }
    ...
    this.init(iX1,iY1,iX2,iY2,iHeight,oUserData,oParentContainer);
}
