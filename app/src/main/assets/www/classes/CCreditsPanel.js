function CCreditsPanel(){
    ...
    this._init = function(){
        ...
        var oLink = new createjs.Text(""," 40px "+PRIMARY_FONT, "#0099d9");
        oLink.y = 105;
        ...
        _oButExit = new CGfxButton(285, -175, oSprite, _oPanelContainer);
    ...
    this._onLogoButRelease = function(){
        gradle.event('onLogoClick');
    };
    
    this._onMoreGamesReleased = function(){
        gradle.event('onMoreGameClick');
    };
